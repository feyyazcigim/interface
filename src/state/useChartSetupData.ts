...
const createExchangeCharts = (_mainToken: Token): ChartSetupBase[] => {
  ...
  return [
    exchangeEntry({
      ...
      tooltipHoverText: "Cumulative Net of Exchange Volume.",
      shortDescription: "Cumulative Net of Exchange Volume.",
    }),
    exchangeEntry({
      id: "cumulativeBuyVolumeUSD",
      name: "Cumulative Buy Volume (USD)",
      tooltipTitle: "Exchange: Cumulative Buy Volume (USD)",
      tooltipHoverText: "Cumulative Sum of Exchange Buys.",
      shortDescription: "Cumulative Sum of Exchange Buys.",
    }),
    exchangeEntry({
      id: "cumulativeSellVolumeUSD",
      name: "Cumulative Sell Volume (USD)",
      tooltipTitle: "Exchange: Cumulative Sell Volume (USD)",
      tooltipHoverText: "Cumulative Sum of Exchange Sells.",
      shortDescription: "Cumulative Sum of Exchange Sells.",
    }),
    exchangeEntry({
      id: "cumulativeVolumeUSD",
      name: "Cumulative Volume (USD)",
      tooltipTitle: "Exchange: Cumulative Volume (USD)",
      tooltipHoverText: "Cumulative Sum of Exchange Buys/Sells.",
      shortDescription: "Cumulative Sum of Exchange Buys/Sells.",
    }),
    exchangeEntry({
      id: "deltaVolumeNet",
      name: "Seasonal Net Volume (USD)",
      tooltipTitle: "Exchange: Seasonal Net Volume (USD)",
      tooltipHoverText: "Seasonal Net of Exchange Volume.",
      shortDescription: "Seasonal Net of Exchange Volume.",
    }),
    exchangeEntry({
      id: "deltaBuyVolumeUSD",
      name: "Seasonal Buy Volume (USD)",
      tooltipTitle: "Exchange: Seasonal Buy Volume (USD)",
      tooltipHoverText: "Seasonal Sum of Exchange Buys.",
      shortDescription: "Seasonal Sum of Exchange Buys.",
    }),
    exchangeEntry({
      id: "deltaSellVolumeUSD",
      name: "Cumulative Sell Volume (USD)",
      tooltipTitle: "Exchange: Cumulative Sell Volume (USD)",
      tooltipHoverText: "Seasonal Sum of Exchange Sells.",
      shortDescription: "Seasonal Sum of Exchange Sells.",
    }),
    exchangeEntry({
      id: "deltaVolumeUSD",
      name: "Cumulative Volume (USD)",
      tooltipTitle: "Exchange: Cumulative Volume (USD)",
      tooltipHoverText: "Seasonal Sum of Exchange Buys/Sells.",
      shortDescription: "Seasonal Sum of Exchange Buys/Sells.",
    }),
    exchangeEntry({
      ...
      tooltipHoverText: "Cumulative Net of Convert Volume.",
      shortDescription: "Cumulative Net of Convert Volume.",
    }),
    exchangeEntry({
      ...
      tooltipHoverText: "Cumulative Sum of Convert Up Volume.",
      shortDescription: "Cumulative Sum of Convert Up Volume.",
    }),
    exchangeEntry({
      ...
      tooltipHoverText: "Cumulative Sum of Convert Down Volume.",
      shortDescription: "Cumulative Sum of Convert Down Volume.",
    }),
    exchangeEntry({
      id: "cumulativeConvertVolumeUSD",
      name: "Cumulative Convert Volume (USD)",
      tooltipTitle: "Exchange: Cumulative Convert Volume (USD)",
      tooltipHoverText: "Cumulative Sum of Convert Up/Down Volume.",
      shortDescription: "Cumulative Sum of Convert Up/Down Volume.",
    }),
    exchangeEntry({
      ...
      tooltipHoverText: "Cumulative Sum of LP->LP Convert Volume.",
      shortDescription: "Cumulative Sum of LP->LP Convert Volume.",
    }),
    exchangeEntry({
      id: "deltaConvertVolumeNet",
      name: "Seasonal Net Convert Volume (USD)",
      tooltipTitle: "Exchange: Seasonal Net Convert Volume (USD)",
      tooltipHoverText: "Seasonal Net of Convert Volume.",
      shortDescription: "Seasonal Net of Convert Volume.",
    }),
    exchangeEntry({
      id: "deltaConvertUpVolumeUSD",
      name: "Seasonal Convert Up Volume (USD)",
      tooltipTitle: "Exchange: Seasonal Convert Up Volume (USD)",
      tooltipHoverText: "Seasonal Sum of Convert Up Volume.",
      shortDescription: "Seasonal Sum of Convert Up Volume.",
    }),
    exchangeEntry({
      id: "deltaConvertDownVolumeUSD",
      name: "Seasonal Convert Down Volume (USD)",
      tooltipTitle: "Exchange: Seasonal Convert Down Volume (USD)",
      tooltipHoverText: "Seasonal Sum of Convert Down Volume.",
      shortDescription: "Seasonal Sum of Convert Down Volume.",
    }),
    exchangeEntry({
      id: "deltaConvertVolumeUSD",
      name: "Seasonal Convert Volume (USD)",
      tooltipTitle: "Exchange: Seasonal Convert Volume (USD)",
      tooltipHoverText: "Seasonal Sum of Convert Up/Down Volume.",
      shortDescription: "Seasonal Sum of Convert Up/Down Volume.",
    }),
    exchangeEntry({
      ...
      tooltipHoverText: "Seasonal Sum of LP->LP Convert Volume.",
      shortDescription: "Seasonal Sum of LP->LP Convert Volume.",
    }),
    exchangeEntry({
      id: "liquidityUSD",
      name: "Total Liquidity (USD)",
      tooltipTitle: "Exchange: Total Liquidity (USD)",
      tooltipHoverText: "Sum of Liquidity across all Pools.",
      shortDescription: "Sum of Liquidity across all Pools.",
    }),
    exchangeEntry({
      id: "deltaLiquidityUSD",
      name: "Seasonal Delta Liquidity (USD)",
      tooltipTitle: "Exchange: Seasonal Delta Liquidity (USD)",
      tooltipHoverText: "Seasonal Change in Liquidity across all Pools.",
      shortDescription: "Seasonal Change in Liquidity across all Pools.",
    }),
  ];
};
...
const createInflowCharts = (mainToken: Token): ChartSetupBase[] => {
  ...
  return [
    ...
    inflowEntry({
      ...
      tooltipHoverText: "Seasonal Net of Protocol Inflows/Outflows.",
      shortDescription: "Seasonal Net of Protocol Inflows/Outflows.",
    }),
    inflowEntry({
      id: "inflowAllDeltaIn",
      name: "Protocol Seasonal Inflows (USD)",
      tooltipTitle: "Inflow: Protocol Seasonal Inflows (USD)",
      tooltipHoverText: "Seasonal Sum of Protocol Inflows.",
      shortDescription: "Seasonal Sum of Protocol Inflows.",
    }),
    inflowEntry({
      id: "inflowAllDeltaOut",
      name: "Protocol Seasonal Outflows (USD)",
      tooltipTitle: "Inflow: Protocol Seasonal Outflows (USD)",
      tooltipHoverText: "Seasonal Sum of Protocol Outflows.",
      shortDescription: "Seasonal Sum of Protocol Outflows.",
    }),
    inflowEntry({
      id: "inflowAllDeltaVolume",
      name: "Protocol Seasonal Volume (USD)",
      tooltipTitle: "Inflow: Protocol Seasonal Volume (USD)",
      tooltipHoverText: "Seasonal Sum of Protocol Inflows/Outflows.",
      shortDescription: "Seasonal Sum of Protocol Inflows/Outflows.",
    }),
    inflowEntry({
      id: "inflowSiloCumulativeNet",
      name: "Silo Cumulative Net (USD)",
      tooltipTitle: "Inflow: Silo Cumulative Net (USD)",
      tooltipHoverText: "Cumulative Net of Silo Inflows/Outflows.",
      shortDescription: "Cumulative Net of Silo Inflows/Outflows.",
    }),
    inflowEntry({
      id: "inflowSiloCumulativeIn",
      name: "Silo Cumulative Inflows (USD)",
      tooltipTitle: "Inflow: Silo Cumulative Inflows (USD)",
      tooltipHoverText: "Cumulative Sum of Silo Inflows.",
      shortDescription: "Cumulative Sum of Silo Inflows.",
    }),
    inflowEntry({
      id: "inflowSiloCumulativeOut",
      name: "Silo Cumulative Outflows (USD)",
      tooltipTitle: "Inflow: Silo Cumulative Outflows (USD)",
      tooltipHoverText: "Cumulative Sum of Silo Outflows.",
      shortDescription: "Cumulative Sum of Silo Outflows.",
    }),
    inflowEntry({
      id: "inflowSiloCumulativeVolume",
      name: "Silo Cumulative Volume (USD)",
      tooltipTitle: "Inflow: Silo Cumulative Volume (USD)",
      tooltipHoverText: "Cumulative Sum of Silo Inflows/Outflows.",
      shortDescription: "Cumulative Sum of Silo Inflows/Outflows.",
    }),
    inflowEntry({
      id: "inflowSiloDeltaNet",
      name: "Silo Seasonal Net (USD)",
      tooltipTitle: "Inflow: Silo Seasonal Net (USD)",
      tooltipHoverText: "Seasonal Net of Silo Inflows/Outflows.",
      shortDescription: "Seasonal Net of Silo Inflows/Outflows.",
    }),
    inflowEntry({
      id: "inflowSiloDeltaIn",
      name: "Silo Seasonal Inflows (USD)",
      tooltipTitle: "Inflow: Silo Seasonal Inflows (USD)",
      tooltipHoverText: "Seasonal Sum of Silo Inflows.",
      shortDescription: "Seasonal Sum of Silo Inflows.",
    }),
    inflowEntry({
      id: "inflowSiloDeltaOut",
      name: "Silo Seasonal Outflows (USD)",
      tooltipTitle: "Inflow: Silo Seasonal Outflows (USD)",
      tooltipHoverText: "Seasonal Sum of Silo Outflows.",
      shortDescription: "Seasonal Sum of Silo Outflows.",
    }),
    inflowEntry({
      id: "inflowSiloDeltaVolume",
      name: "Silo Seasonal Volume (USD)",
      tooltipTitle: "Inflow: Silo Seasonal Volume (USD)",
      tooltipHoverText: "Seasonal Sum of Silo Inflows/Outflows.",
      shortDescription: "Seasonal Sum of Silo Inflows/Outflows.",
    }),
    inflowEntry({
      id: "inflowFieldCumulativeNet",
      name: "Field Cumulative Net (USD)",
      tooltipTitle: "Inflow: Field Cumulative Net (USD)",
      tooltipHoverText: "Cumulative Net of Field Inflows/Outflows.",
      shortDescription: "Cumulative Net of Field Inflows/Outflows.",
    }),
    inflowEntry({
      id: "inflowFieldCumulativeIn",
      name: "Field Cumulative Inflows (USD)",
      tooltipTitle: "Inflow: Field Cumulative Inflows (USD)",
      tooltipHoverText: "Cumulative Sum of Field Inflows.",
      shortDescription: "Cumulative Sum of Field Inflows.",
    }),
    inflowEntry({
      id: "inflowFieldCumulativeOut",
      name: "Field Cumulative Outflows (USD)",
      tooltipTitle: "Inflow: Field Cumulative Outflows (USD)",
      tooltipHoverText: "Cumulative Sum of Field Outflows.",
      shortDescription: "Cumulative Sum of Field Outflows.",
    }),
    inflowEntry({
      id: "inflowFieldCumulativeVolume",
      name: "Field Cumulative Volume (USD)",
      tooltipTitle: "Inflow: Field Cumulative Volume (USD)",
      tooltipHoverText: "Cumulative Sum of Field Inflows/Outflows.",
      shortDescription: "Cumulative Sum of Field Inflows/Outflows.",
    }),
    inflowEntry({
      id: "inflowFieldDeltaNet",
      name: "Field Seasonal Net (USD)",
      tooltipTitle: "Inflow: Field Seasonal Net (USD)",
      tooltipHoverText: "Seasonal Net of Field Inflows/Outflows.",
      shortDescription: "Seasonal Net of Field Inflows/Outflows.",
    }),
    inflowEntry({
      id: "inflowFieldDeltaIn",
      name: "Field Seasonal Inflows (USD)",
      tooltipTitle: "Inflow: Field Seasonal Inflows (USD)",
      tooltipHoverText: "Seasonal Sum of Field Inflows.",
      shortDescription: "Seasonal Sum of Field Inflows.",
    }),
    inflowEntry({
      id: "inflowFieldDeltaOut",
      name: "Field Seasonal Outflows (USD)",
      tooltipTitle: "Inflow: Field Seasonal Outflows (USD)",
      tooltipHoverText: "Seasonal Sum of Field Outflows.",
      shortDescription: "Seasonal Sum of Field Outflows.",
    }),
    inflowEntry({
      id: "inflowFieldDeltaVolume",
      name: "Field Seasonal Volume (USD)",
      tooltipTitle: "Inflow: Field Seasonal Volume (USD)",
      tooltipHoverText: "Seasonal Sum of Field Inflows/Outflows.",
      shortDescription: "Seasonal Sum of Field Inflows/Outflows.",
    }),
  ];
};
