    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        ...
        >
          ...
          {/* Definition section */}
          <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl leading-[1.2] font-thin text-black prose prose-neutral max-w-none prose-strong:font-bold flex-shrink-0">
